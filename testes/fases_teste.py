...
# PYGAME
import pygame
from pygame             import Surface  as Superficie , KEYDOWN as TECLA_SEGURADA , KEYUP as TECLA_APERTADA , K_LEFT as ESQUERDA , K_RIGHT as DIREITA 
...
if __name__ == "__main__":
    ...
    @fase.Fase_Evento(tipo_evento= ENTER , auto= True)
    def nova_fase( 
        screen :Superficie, 
                info_extra = None,
                    index: Fase_Componentes = None,
